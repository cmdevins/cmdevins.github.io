...
const eventName = "April League Challenge";
const eventDate = "April 18, 2026";
const players = [
...
<head>
  ...
  <title>April League Challenge Results</title>
  <style>
    :root {
...
<body>
  <header>
    ...
    <h1>Top 4 Decklists</h1>
    <p class="sub">${eventName} • ${eventDate}</p>
  </header>
  <main class="list" aria-label="Top 4 decks">
    ${cards}
  </main>
